    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1e3a5f] flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-white/60 text-lg">La forma más eficiente y económica de viajar por Argentina.</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 px-6">
        <div className="w-full max-w-sm">
          ...
          <p className="text-slate-500 text-sm mb-6">Ingresá a tu cuenta para continuar</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ¿No tenés cuenta?{" "}
            <Link href="/auth/register" className="text-sky-600 font-medium hover:underline">Registrate gratis</Link>
          </p>
          <p className="mt-2 text-center">
            <Link href="/" className="text-xs text-slate-400 hover:underline">← Volver al inicio</Link>
          </p>
        </div>
      </div>
    </div>
